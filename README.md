...
If you wish to rebuild the dataset from the source API, follow this pipeline:
    ...
    This parses the JSON files, classifies positive and negative tactical shocks, and calculates the Strategic Yield (ΔGt​) across multiple temporal horizons (t in {30, 60, 120, 180} seconds) strictly following the conclusion of the combat event. It outputs tf_events_master_unified.csv.
